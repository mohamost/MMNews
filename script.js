// التأكد من أن مكتبة فايربيس تم تحميلها من الإنترنت
if (typeof firebase !== 'undefined') {
    ...
    console.log("تم اتصال فايربيس بنجاح 🍉");
} else {
    console.error("خطأ: مكتبة فايربيس لم يتم تحميلها. تأكد من ترتيب الأسطر في HTML");
}

// باقي الكود الخاص بـ window.onload والدوال الأخرى يكمل هنا...
